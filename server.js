...
For Benchmark 001 use EXACTLY 8 points in this topology:
bottom-left → bottom-right → right shoulder → extractor right-lower →
extractor right-top → extractor left-top → extractor left-lower → left shoulder → close.
